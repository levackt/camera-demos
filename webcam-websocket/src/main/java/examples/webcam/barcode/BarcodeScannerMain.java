...
package examples.webcam.barcode; import examples.webcam.face.FaceDetectionRoute;
import org.apache.camel.main.Main;

/**
 * A main to start this example.
 */
public final class BarcodeScannerMain {

    private BarcodeScannerMain() {
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        BarcodeScannerRoute route = new BarcodeScannerRoute();
